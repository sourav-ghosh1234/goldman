...
/**
 * @api {get} /services/renovation-interior Renovation-Interior Design
 * @apiVersion 1.0.0
 * @apiGroup Service Content
 * @apiSuccessExample {json} Success
 * {
...
namedRouter.get("api.services.renovation.interior", '/services/renovation-interior', async (req, res) => {
  try {
      const success = await servicesContentController.getRenovationInterior(req, res);
      res.status(success.status).send(success);
  } catch (error) {
      res.status(error.status).send(error);
  }
...
/**
 * @api {get} /services/property-management Property Management
 * @apiVersion 1.0.0
 * @apiGroup Service Content
 * @apiSuccessExample {json} Success
 * {
...
namedRouter.get("api.services.property.management", '/services/property-management', async (req, res) => {
  try {
      const success = await servicesContentController.getPropertyManagement(req, res);
      res.status(success.status).send(success);
  } catch (error) {
      res.status(error.status).send(error);
  }
