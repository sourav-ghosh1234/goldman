            ...
            if (_.isObject(req.body.query) && _.has(req.body.query, 'generalSearch')) {
                and_clauses.push({
                    $or: [
                        ...
                        { 'user_name': { $regex: req.body.query.generalSearch, $options: 'i' } }
                    ]
                });
            }
    ...
    getAllUsers: async(req) => {
        try {
            ...
            if (_.isObject(req.body.query) && _.has(req.body.query, 'generalSearch')) {
                and_clauses.push({
                    $or: [
                        { 'outlined': { $regex: req.body.query.generalSearch, $options: 'i' } },
                        { 'first_name': { $regex: req.body.query.generalSearch, $options: 'i' } },
                        { 'last_name': { $regex: req.body.query.generalSearch, $options: 'i' } },
                        { 'email': { $regex: req.body.query.generalSearch, $options: 'i' } },
                        { 'phone_number': { $regex: req.body.query.generalSearch, $options: 'i' } },
                        { 'planData.header': { $regex: req.body.query.generalSearch, $options: 'i' } },
                    ]
                });
            }
            ...
            if (_.isObject(req.body.query) && _.has(req.body.query, 'Plan')) {
                and_clauses.push({ "plan_id": mongoose.Types.ObjectId(req.body.query.Plan) });
            }
