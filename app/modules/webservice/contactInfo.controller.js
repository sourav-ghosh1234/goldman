    ...
    */
    async save(req, res) {
        try {
            ...
            let contactSave = await contactInfoRepo.save(req.body);
            if (contactSave) {
                let mailOptions = {
                    ...
                    html: `Hello Admin,<br>
                    <p>Contact details.</p>
                    <p>Name: ${contactSave.prefix}. ${contactSave.first_name} ${contactSave.last_name}</p>
                    <p>Email: ${contactSave.email}</p>
                    <p>Phone: ${contactSave.phone_number}</p>
                ...
                if (sendEmail) {
                    let mailOptionsForUser = {
                        ...
                        to: req.body.email,
                        subject: 'Contact Us | Goldman Prestige',
                        html: `Hello ${contactSave.prefix}. ${contactSave.first_name} ${contactSave.last_name},<br>
